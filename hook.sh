...
deploy_challenge() {
	...
	curl "https://freemyip.com/update?token=$token&domain=$1&myip=$myip&txt=$3"
    echo "Waiting 2 minuts for DNS propagation."
    sleep 2m
}
...
clean_challenge() {
	...
	curl "https://freemyip.com/update?token=$token&domain=$1&myip=$myip&txt=null"
}
